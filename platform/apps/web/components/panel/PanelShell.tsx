...
const NAV: { href: string; label: string; icon: ReactNode; disabled?: boolean }[] = [
  ...
  { href: "/painel/estoque", label: "Estoque", icon: <path d="M5 13l1.5-4.5A2 2 0 0 1 8.4 7h7.2a2 2 0 0 1 1.9 1.5L19 13v4H5z" />, disabled: true },
  { href: "/painel/marketing", label: "Marketing", icon: <path d="M3 11l18-8-8 18-2-8z" />, disabled: true },
  { href: "/painel/financeiro", label: "Financeiro", icon: <path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />, disabled: true },
];
