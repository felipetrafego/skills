...
| `POST` | `/api/auth/refresh` | Rotaciona o refresh token (novo par; detecta reuso e revoga a cadeia) |
| `POST` | `/api/auth/logout` | Revoga o refresh token (encerra a sessão no servidor) |
